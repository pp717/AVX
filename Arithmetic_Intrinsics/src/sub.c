...
int main(int argc, char const *argv[]) {
    ...
    __m256 float_result = _mm256_sub_ps(float_vec_0, float_vec_1);
    ...
    __m256d double_result = _mm256_sub_pd(double_vec_0, double_vec_1);
    ...
    __m256i epi8_result = _mm256_sub_epi8(epi8_vec_0, epi8_vec_1);
    ...
    __m256i epi16_result = _mm256_sub_epi16(epi16_vec_0, epi16_vec_1);
    ...
    __m256i epi32_result = _mm256_sub_epi32(epi32_vec_0, epi32_vec_1);
